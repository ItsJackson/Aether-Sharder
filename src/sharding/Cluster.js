...
try {
    Aetherlib = require('aether-library-additions')(require('aether-library'));
} catch (err) {
    Aether = require('aether-library')
}

const Base = require('../structures/Base');
const SyncedRequestHandler = require('../structures/SyncedRequestHandler');
const { inspect } = require('util')
const IPC = require('../structures/IPC');
 ...
 */
 class Cluster {
    ...
    connect(firstShardID, lastShardID, maxShards, token, type, clientOptions) {
        ...
        const bot = new Aether(token, options);
        this.bot = bot;
